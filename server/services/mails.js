exports.generateEmailTemplate = (name, email, user_id) => {
                ...
                <td style="padding: 40px 0px 0px;">
                  ...
                  <div style="padding: 20px; background-color: rgb(255, 255, 255);">
                    <div style="color: rgb(0, 0, 0); text-align: center;">
                      ...
                      <p style="padding-bottom: 16px">Please clink on the link below to confirm your account.</p>
                      <a href="http://localhost:8080/verify/${user_id}"> Verify here</a>
                      <p style="padding-bottom: 16px">Thanks,<br>Dentisimo team 5</p>
                    </div>
                  </div>
